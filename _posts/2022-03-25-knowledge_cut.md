...
(<a href=https://ko.wikipedia.org/wiki/%EB%B2%84%ED%8D%BC_(%EC%BB%B4%ED%93%A8%ED%84%B0_%EA%B3%BC%ED%95%99></a>))


2. O(N): 리스트의 아이템 수에 비례한다는 뜻<br/>
    O(1): 시간 상수로 아이템 수와 무관하다.<br/>
    O(log N) : log(N)에 비례하는 시간
