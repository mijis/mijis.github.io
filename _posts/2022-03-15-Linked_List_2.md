...
위의 첫 그림처럼 양방향 Linked List는 다음 주소를 가지고 있을뿐 아니라 앞의 노드 주소도 가지고 있다. 이로 인해 앞 뒤로 자유롭게 이동할 수 있다. 여기에 새로운 노드를 삽입하기 위해서는 위의 두 번째 그림처럼 앞 뒤의 주소를 가져오고 자신의 주소를 앞뒤로 보내주면 된다. 단방향 삽입과 똑같지만 앞의 노드에 자신의 주소르 보내고, 뒤의 주소 또한 가져온다는 것만 다르다.
